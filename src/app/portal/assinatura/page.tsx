...
export default function Page() {
  ...
  return (
    <PortalLayout title="Assinatura" userName={profile.full_name} userRole={profile.role} isAdmin={profile.role==='advogadu'}>
      <div className="card" style={{textAlign:'center',padding:'60px',color:'var(--text-muted)'}}>
        <div style={{fontSize:'3rem',marginBottom:'16px'}}>🚧</div>
        <h3 style={{fontFamily:'Playfair Display,serif',marginBottom:'8px'}}>Assinatura</h3>
